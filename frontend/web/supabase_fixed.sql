-- First, let's check the structure of your organizations table 
-- (run this separately to see the columns)
-- SELECT column_name, data_type, is_nullable 
-- FROM information_schema.columns 
-- WHERE table_name = 'organizations';

-- Sample data for organizations with owner_id
INSERT INTO organizations (id, name, description, owner_id)
VALUES 
  ('11111111-1111-1111-1111-111111111111', 'Acme Corporation', 'A global enterprise with diverse operations', '00000000-0000-0000-0000-000000000001'),
  ('22222222-2222-2222-2222-222222222222', 'Stark Industries', 'Leading technology innovator', '00000000-0000-0000-0000-000000000001');
