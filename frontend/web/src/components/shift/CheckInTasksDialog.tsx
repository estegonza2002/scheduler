...
import { CheckInTask } from "../../api";
import { Plus, Save, Check, X, Edit, Trash } from "lucide-react";
import { parseMentions } from "../../utils/text-formatting";

interface CheckInTasksDialogProps {
	open: boolean;
	onOpenChange: (open: boolean) => void;
	tasks: CheckInTask[];
	onSave: (tasks: CheckInTask[]) => void;
}

export function CheckInTasksDialog({
	open,
	onOpenChange,
	tasks,
	onSave,
}: CheckInTasksDialogProps) {
	const [editTasks, setEditTasks] = useState<CheckInTask[]>([]);
