	...
	const DateRangePickerComponent = () => {
		return (
			<div className="flex space-x-2">
				...
				<ExportDropdown
					data={getExportData()}
					filename={`${employee.name.replace(/\s+/g, "_")}_Earnings_Report`}
				/>
			</div>
		);
	};
		...
		<>
			...
			<ContentContainer>
				<ContentSection
					...
					description="Select a time period to view earnings data">
					{/* Date Range Selector */}
					<div className="mb-4">
						<Tabs
							value={activeTab}
					...
					<ContentSection
						...
						<div className="space-y-2">
							...
							<div className="flex justify-between items-center">
								...
								<span className="font-medium">{reportData.length} shifts</span>
							</div>
							<Separator />
