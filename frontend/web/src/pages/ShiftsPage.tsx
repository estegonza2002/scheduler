										...
										<div className="flex items-center space-x-2">
											...
											<DropdownMenu>
												...
												<DropdownMenuContent
													...
													<DropdownMenuItem
														onSelect={() =>
															handleDateFilterSelect("yesterday")
														}>
														Yesterday
													</DropdownMenuItem>
													<DropdownMenuItem
														onSelect={() =>
															handleDateFilterSelect("last7days")
														}>
														Last 7 days
													</DropdownMenuItem>
													<DropdownMenuItem
														onSelect={() =>
															handleDateFilterSelect("last15days")
														}>
														Last 15 days
													</DropdownMenuItem>
													<DropdownMenuItem
														onSelect={() =>
															handleDateFilterSelect("last30days")
														}>
														Last 30 days
													</DropdownMenuItem>
													<DropdownMenuSeparator />
															...
															<Card className="hover:border-primary transition-colors">
																...
																<CardContent>
																	<div className="grid grid-cols-2 gap-2 text-sm">
																		...
																		<div>
																			Sched: {shift.totalScheduledHours}h
																		</div>
